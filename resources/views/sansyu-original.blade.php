<x-layout title="三秀">
    ...
    <main class="flex flex-col items-center gap-4 w-full max-w-[520px] m-auto">
        <div class="flex flex-col items-center pt-36 xl:pt-48 md:pt-0">
            <img src="{{asset("storage/img/sansyu-top.jpg")}}" class="object-cover pb-4" alt="image">
        ...
        <div class="bg-main_bg md:w-[88%] w-full px-4 md:px-8 py-12 flex flex-col gap-8">
            ...
            <section id="message" class="bg-white flex flex-col items-center py-12 px-5 gap-2 rounded-md">
                ...
                <img src="{{asset("storage/img/president.png")}}" class="object-cover rounded-md" alt="image">
                ...
                <div class="w-full">
                    <iframe width="348" class="w-full" height="258" src="https://www.youtube.com/embed/XI9MvnfwbbA?si=y65NVNuwXv86t42-" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture;" allowfullscreen></iframe>
                </div>
            </section>
            ...
            <section id="product" class="bg-white flex flex-col items-center py-12 px-5 gap-2 rounded-md">
                ...
                <img src="{{asset("storage/img/column.png")}}" class="object-cover rounded-md" alt="image">
                    ...
                    @foreach($interviews as $value)
                        <a href="{{route("interview",$value["id"])}}" class="block w-full h-full">
                            <article class="bg-interview_orange px-6 pt-16 pb-6 shadow-md">
                                <img src="{{asset('storage/img/'.$value["path"])}}" class="w-employee_width h-employee_height object-cover" alt="image">
                ...
                @foreach($recruitment as $value)
                    <a href="{{$value['url']!=null?route($value['url']):$value["link"]}}" class="w-full block h-full border-b border-solid border-sky-300">
                        <article class="flex items-center py-2 gap-4 w-full">
                            <img src="{{asset('storage/img/'.$value["path"])}}" class="w-12 h-12 object-cover" alt="image">
